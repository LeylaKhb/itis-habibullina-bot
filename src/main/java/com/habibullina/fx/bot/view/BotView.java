package com.habibullina.fx.bot.view;

import com.habibullina.fx.bot.utils.MessageHandler;
import com.habibullina.fx.chat.ChatApplication;
...
public class BotView extends BaseView {
    ...
    private final EventHandler<KeyEvent> eventHandler = new EventHandler<>() {
        ...
        public void handle(KeyEvent event) {
            if (event.getCode() == KeyCode.ENTER) {
                ...
                if (answer.equals(messageHandler.getChatStartingPhrase())) {
                    ChatApplication chatApplication = new ChatApplication();
                    try {
                        chatApplication.start(getBotApplication().getStage());
                    } catch (Exception e) {
    ...
    private void createView() {
        ...
        conversation.appendText("Bot: " + messageHandler.getNotStartedAnswer() + "\n");
    }
}
